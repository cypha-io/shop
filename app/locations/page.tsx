            ...
            <div key={location.name} className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow border border-gray-200">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <FiMapPin className="text-xl text-orange-500 mt-1 flex-shrink-0" />
                  <p className="text-gray-700">{location.address}</p>
                </div>
                
                <div className="flex items-start gap-3">
                  <FiPhone className="text-xl text-orange-500 mt-1 flex-shrink-0" />
                  <p className="text-gray-700">{location.phone}</p>
                </div>
                
                <div className="flex items-start gap-3">
                  <FiClock className="text-xl text-orange-500 mt-1 flex-shrink-0" />
