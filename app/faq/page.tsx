  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 md:px-6 py-6 md:py-12 mb-20 md:mb-0">
        ...
        <div className="mt-12 text-center bg-orange-50 rounded-lg p-8 shadow-sm border border-orange-50">
          ...
          <a href="/contact" className="inline-block bg-orange-500 text-white px-8 py-3 rounded-full font-bold hover:bg-orange-600">
            Contact Us
          </a>
        </div>
      </main>
