  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 md:px-6 py-6 md:py-12 mb-20 md:mb-0">
        <h1 className="text-3xl md:text-5xl font-black text-gray-800 mb-4 md:mb-8 text-center">About Wig Factory</h1>

        <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-200 space-y-6">
          <p className="text-lg text-gray-700 leading-relaxed">
            Welcome to Wig Factory, your go-to destination for premium wigs and hair pieces delivered right to your door. Since our founding, we&apos;ve been committed to using only the finest materials and craftsmanship to create styles that bring joy to every look.
          </p>
